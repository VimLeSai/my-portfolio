...
export const metadata = {
  title: 'Engineering Archive — Vimal Desai | Technical Articles & Insights',
  description:
    "Read Vimal Desai's technical explorations, system architecture deep-dives, and engineering leadership frameworks.",
};
...
export default function ArchivePage() {
  ...
  return (
    <>
      ...
      <Footer
        brandName="Vimal Desai"
        tagline="A digital space dedicated to the intersection of complex system engineering and intentional design."
      />
