...
export default function ResumeHeader({ meta }) {
  return (
    <header className="border-ink before:bg-accent relative mb-10 grid items-end gap-8 border-b-[3px] pb-8 before:absolute before:top-[64px] before:left-4 before:h-1 before:w-16 before:content-[''] md:grid-cols-[1fr_auto]">
      {/* Name block */}
      <div>
      ...
      {/* Contact block */}
      <div className="animate-fade-up flex flex-col items-end text-right delay-[250ms]">
        <a
