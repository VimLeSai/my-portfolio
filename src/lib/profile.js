...
export const profile = {
  ...
  bio: {
    short:
      'Full-stack engineer with 10+ years of experience across ERP, CRM, logistics, real estate, and healthcare. I specialize in React, Node.js, and TypeScript, and care deeply about clean architecture, team velocity, and thoughtful engineering.',
  ...
  socials: [
    {
      ...
      icon: 'github',
      snippet:
        'Shipping across frontend, backend & shared libraries — repos, packages, and experiments under VimLeSai.',
    },
    {
      id: 'linkedin',
      label: 'LinkedIn',
      ...
      icon: 'linkedin',
      snippet:
        'Senior Full Stack Engineer · React, Node.js, TypeScript · Experience at UpKeep and prior product teams.',
    },
    {
      id: 'upwork',
      label: 'Upwork',
      href: 'https://www.upwork.com/freelancers/vimlesai',
      handle: 'vimlesai',
      enabled: true,
      icon: 'upwork',
      snippet:
        'Senior Full Stack Architect (Next.js/Node) — contract and product engineering work.',
    },
    {
      id: 'npm',
      label: 'npm',
      href: 'https://www.npmjs.com/~vimlesai',
      handle: 'vimlesai',
      enabled: true,
      icon: 'npm',
      snippet: 'Published packages and scoped modules under @vimlesai / vimlesai.',
    },
    {
      id: 'stackoverflow',
      label: 'Stack Overflow',
      href: 'https://stackoverflow.com/users/7801396/vimlesai',
      handle: 'vimlesai',
      enabled: true,
      icon: 'stackoverflow',
      snippet: 'Answers, questions, and profile as VimLeSai.',
    },
    {
      id: 'site',
      label: 'vimlesai.io',
      href: 'https://vimlesai.io/',
      handle: 'vimlesai',
      enabled: true,
      icon: 'globe',
      snippet:
        'Personal portfolio — selected work, process, and contact for Vimal Desai.',
    },
    {
      id: 'contra',
      label: 'Contra',
      href: 'https://contra.com/VimLeSai/about',
      handle: 'VimLeSai',
      enabled: true,
      icon: 'contra',
      snippet: 'Independent full-stack profile on Contra.',
    },
    {
      id: 'twitter',
      label: 'Twitter / X',
    ...
    },
    {
      id: 'toptal',
      label: 'Toptal',
      href: 'https://www.toptal.com/resume/vimal-desai',
      handle: 'vimal-desai',
      enabled: true,
      icon: 'toptal',
      snippet: 'Toptal resume listing for Vimal Desai.',
    },
    {
      id: 'instagram',
      label: 'Instagram',
      href: 'https://www.instagram.com/vimlesai/',
      handle: 'vimlesai',
      enabled: true,
      icon: 'instagram',
      snippet: 'Personal Instagram — @vimlesai.',
    },
    {
      id: 'dribbble',
      label: 'Dribbble',
